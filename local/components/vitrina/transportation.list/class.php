        ...
        return [
            ...
            4 => [
                ...
                'DOCUMENTS' => [
                    ...
                    2 => [
                        'ID' => 'donkey_sec_lias_link',
                        'NAME' => 'Договор с лизинговой компанией',
                        'LINK_ID' => 'donkey_sec_lias_file',
                        'FILE' => true,
                    ],
                    3 => [
                        'ID' => 'donkey_sec_cer_link',
                        'NAME' => 'Свидетельство о браке',
                        'LINK_ID' => 'donkey_sec_cer_file',
                        'FILE' => true,
                    ],
                    4 => [
                        'ID' => 'donkey_sec_usage_link',
                        'NAME' => 'Договор безвозмездного использования',
                        'LINK_ID' => 'donkey_sec_usage_file',
                        'FILE' => true,
                    ],
                ],
            ],
