            ...
            onsuccess: function(response){
                if (response.status === 'success') {
                    ...
                    if (carriage.DOC_EXP_LINK != null) {
                        $('#exp_link').show();
                        $('#exp_link').removeClass('status-info_confirmation_error');
                        $('#esp_file').show().attr("href", carriage.DOC_EXP_LINK);
                    } else {
                        $('#exp_link').addClass('status-info_confirmation_error');
                        $('#esp_file').hide().attr("href", '');
                    }
                    /** Экспедиторская расписка */
                    if (carriage.DOC_EXP_RECEIPT_LINK != null) {
                        $('#receipt_link').show();
                        $('#receipt_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.ACC_CHECKS != null) {
                        ...
                        if (carriage.ACC_CHECKS_ERROR !== false) {
                            $('#auto_check').addClass('detail-status_good').html(carriage.ACC_CHECKS);
                        } else {
                            $('#auto_check').addClass('detail-status_error').html('Выполнено ' + carriage.AUTO_CHECKS);
                        }
                    } else {
                    ...
                    if (carriage.ACC_INVOICE_LINK != null) {
                        $('#invoice_link').show();
                        $('#invoice_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.ACC_ACT_ACC_LINK != null) {
                        $('#act_link').show();
                        $('#act_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.ACC_ACT_MULTI_TRANSPORT_LINK_VALUE != null) {
                        $('#multi_link').show();
                        $('#multi_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.ACC_TRANSPORT_REG_LINK != null) {
                        $('#reg_link').show();
                        $('#reg_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.ACC_TAX_INVOICE_LINK != null) {
                        $('#tax_link').show();
                        $('#tax_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.ACC_UPD_LINK != null) {
                        $('#upd_link').show();
                        $('#upd_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.DONKEY_STS_LINK != null) {
                        $('#donkey_link').show();
                        $('#donkey_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRAILER_STS_LINK != null) {
                        ...
                        $('#trailer_ctc_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRAILER_RENT_AGR_LINK != null) {
                        ...
                        $('#trailer_rent_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRAILER_SEC_STS_LINK != null) {
                        ...
                        $('#trailer_sec_ctc_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRAILER_SEC_RENT_LINK != null) {
                        ...
                        $('#trailer_sec_rent_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRAILER_SEC_LEASING_COMPANY_LINK != null) {
                        ...
                        $('#trailer_sec_lias_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRAILER_SEC_CERTIFICATE_LINK != null) {
                        ...
                        $('#trailer_sec_cer_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRAILER_SEC_FREE_USAGE_LINK != null) {
                        ...
                        $('#trailer_sec_usage_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRUCK_STS_LINK != null) {
                        $('#truck_sts_link').show();
                        $('#truck_sts_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRUCK_LEASING_COMPANY_LINK != null) {
                        ...
                        $('#truck_leas_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRUCK_CERTIFICATE_LINK != null) {
                        ...
                        $('#truck_cert_link').removeClass('status-info_confirmation_error');
                    ...
                    if (carriage.TRUCK_FREE_USAGE_LINK != null) {
                        ...
                        $('#truck_usage_link').removeClass('status-info_confirmation_error');
